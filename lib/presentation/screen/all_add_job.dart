...
class AllAddsJob extends StatefulWidget {
  const AllAddsJob({super.key});

  @override
  State<AllAddsJob> createState() => _AllAddsJobState();
}

class _AllAddsJobState extends State<AllAddsJob> {
  ...
  Widget _buildFilterChipDropdown({
    ...
    return DropdownSearch<String>(
      ...
      dropdownBuilder: (context, selectedItem) {
        return Text(
          selectedItem ?? hint,
          textAlign: TextAlign.center, // تم تعديل المحاذاة لتناسب التصميم
          overflow: TextOverflow.ellipsis,
          maxLines: 1,
          style: TextStyle(
            fontSize: 12.sp, // حجم خط مناسب
            color: KTextColor,
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      // ✅ (تم التعديل) صف الفلاتر التفاعلي
                      // Padding(
                      //   padding:
