          ...
          child: Column(
            ...
            children: [
              ...
              _buildFormRow([
                ...
                _buildSingleSelectField(context, s.district, selectedDistrict, ['Deira', 'Al Barsha'], (selection) => setState(() => selectedDistrict = selection)),
              ]),
              const SizedBox(height: 7),

              _buildFormRow([
                _buildTitledTextFormField(s.area, 'Souq Gawa', _areaController, borderColor, currentLocale),
                _buildTitledTextFormField(s.price, '3500', _priceController, borderColor, currentLocale, isNumber: true),
              ]),
              const SizedBox(height: 7),

              _buildFormRow([
                _buildTitledTextFormField(s.productName, 'iPhone 17', _productNameController, borderColor, currentLocale),
                _buildSingleSelectField(context, s.sectionType, selectedSectionType, ['Mobiles', 'Laptops', 'Tablets'], (selection) => setState(() => selectedSectionType = selection)),
              ]),
              const SizedBox(height: 7),
              ...
              TitledSelectOrAddField(
                ...
                items: ['Sharaf DG', 'Jumbo Electronics'],
