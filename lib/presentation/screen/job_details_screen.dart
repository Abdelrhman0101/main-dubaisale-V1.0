                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      left: MediaQuery.of(context).size.width / 2 -
                          (job.images.length * 10.w / 2),
                      child: Row(
                        children:
                            List.generate(job.images.length, (index) {
                          return Container(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          '${_currentPage + 1}/${job.images.length}',
                          style:
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Directionality(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // RichText(
                            //   text: TextSpan(
                            //     children:  job.line1.split(' ').map((word) {
                      ...
                      //   children: [
                      //     _buildDetailBox(
                      //         S.of(context).car_type, widget.job.carType),
                      //     _buildDetailBox(
                      //         S.of(context).trans_type, widget.job.transType),
                      //     _buildDetailBox(
                      //         S.of(context).color, widget.job.color),
                      //     _buildDetailBox(S.of(context).interior_color,
                      //         widget.job.interiorColor),
                      //     _buildDetailBox(
                      //         S.of(context).fuel_type, widget.job.fuelType),
                      //     _buildDetailBox(
                      //         S.of(context).warranty, widget.job.warranty),
                      //     _buildDetailBox(S.of(context).doors_no,
                      //         widget.job.doors.toString()),
                      //     _buildDetailBox(S.of(context).seats_no,
                      //         widget.job.seats.toString()),
                      //     _buildDetailBox(S.of(context).engine_capacity,
                      //         widget.job.engineCapacity),
                      //     _buildDetailBox(S.of(context).cylinders,
                      //         widget.job.cylinders.toString()),
                      //     _buildDetailBox(
                      //         S.of(context).horse_power, widget.job.horsePower),
                      //     _buildDetailBox(S.of(context).steering_side,
                      //         widget.job.steeringSide),
                      //   ],
                      // ),
                      // SizedBox(height: 1.h),
                      Divider(color: Color(0xFFB5A9B1), thickness: 1.h),
                      ...
                      Directionality(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: ReadMoreText(
                                "We hiring cleaner with experience Job with one duty shift one day off",
                                trimLines: 2,
                                colorClickableText:
