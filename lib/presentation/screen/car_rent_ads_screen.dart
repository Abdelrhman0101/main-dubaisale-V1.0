...
class _CarsRentAdScreenState extends State<CarsRentAdScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text(s.carsRentAds, style: TextStyle(fontWeight: FontWeight.w500, fontSize: 24.sp, color: KTextColor)),
              ),
              ...
              _buildFormRow([
                ...
                _buildSingleSelectField(context, s.make, selectedMake, ['Audi', 'BMW', 'Mercedes'], (selection) => setState(() => selectedMake = selection)),
              ]),
              const SizedBox(height: 7),

              _buildFormRow([
                _buildSingleSelectField(context, s.model, selectedModel, ['S5', 'A8', 'X7'], (selection) => setState(() => selectedModel = selection)),
                _buildSingleSelectField(context, s.trim, selectedTrim, ['TSI', 'TDI', 'M-Kit'], (selection) => setState(() => selectedTrim = selection)),
                _buildTitledTextFormField(s.price, '600', _priceController, borderColor, currentLocale, isNumber: true),
              ]),
              const SizedBox(height: 7),

              _buildFormRow([
                _buildSingleSelectField(context, s.year, selectedYear, ['2023', '2022', '2021'], (selection) => setState(() => selectedYear = selection)),
                _buildTitledTextFormField(s.dayRent, '600', _dayRentController, borderColor, currentLocale, isNumber: true),
                _buildTitledTextFormField(s.monthRent, '12000', _monthRentController, borderColor, currentLocale, isNumber: true),
              ]),
              const SizedBox(height: 7),
              ...
              _buildFormRow([
                _buildSingleSelectField(context, s.carType, selectedCarType, ['SUV', 'Sedan'], (selection) => setState(() => selectedCarType = selection)),
                _buildSingleSelectField(context, s.transType, selectedTransType, ['Auto', 'Manual'], (selection) => setState(() => selectedTransType = selection)),
                _buildSingleSelectField(context, s.fuelType, selectedFuelType, ['Petrol', 'Diesel'], (selection) => setState(() => selectedFuelType = selection)),
              ]),
              const SizedBox(height: 7),

              _buildFormRow([
                _buildSingleSelectField(context, s.color, selectedColor, ['White', 'Black'], (selection) => setState(() => selectedColor = selection)),
                _buildSingleSelectField(context, s.interiorColor, selectedInteriorColor, ['Red', 'Black'], (selection) => setState(() => selectedInteriorColor = selection)),
                _buildSingleSelectField(context, s.seatsNo, selectedSeats, ['4', '5', '7'], (selection) => setState(() => selectedSeats = selection)),
              ]),
              const SizedBox(height: 7),
              _buildTitledTextFormField(s.area, s.area, _areaController, borderColor, currentLocale),
              const SizedBox(height: 7),
              ...
              _buildFormRow([
                TitledSelectOrAddField(
                  ...
                  items: ['00971508236561', '00971501234567'],
                ...
                TitledSelectOrAddField(
                  ...
                  items: ['00971508236561', '00971507654321'], 
              ...
              TitledSelectOrAddField(
                ...
                items: ['Alwan Rental', 'Diamond Cars'],
              ...
              TitledDescriptionBox(title: s.describeYourCar, initialValue: '20% Down Payment With Insurance Registration And Delivery To Client Without Fees', borderColor: borderColor),
              const SizedBox(height: 10),

              _buildImageButton(s.addMainImage, Icons.add_a_photo_outlined, borderColor),
              const SizedBox(height: 7),
              _buildImageButton(s.add10Images, Icons.add_photo_alternate_outlined, borderColor),
              const SizedBox(height: 7),
  ...
  // --- دوال المساعدة المنقولة والموحدة ---
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              // ++ تم حذف زر Reset من هنا ++
              Center(
                child: Text(widget.title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.sp, color: KTextColor))
              ),
              const SizedBox(height: 16),
              TextFormField(
