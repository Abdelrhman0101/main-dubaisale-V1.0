                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: _countryCodes.entries.map((entry) {
                            return DropdownMenuItem<String>(
                              value: entry.value,
                              child: Text(entry.value, style: TextStyle(fontWeight: FontWeight.w500, color: KTextColor, fontSize: 12)),
                            );
                          }).toList(),
                          onChanged: (value) {
                            setState(() {
                ...
                ElevatedButton(
                  onPressed: () { 
                    if (_addController.text.isNotEmpty) {
                      final fullNumber = widget.isNumeric 
                          ? '$_selectedCountryCode${_addController.text.trim()}'
