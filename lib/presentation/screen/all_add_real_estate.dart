...
class AllAdsRealEstate extends StatefulWidget {
  const AllAdsRealEstate({super.key});

  @override
  State<AllAdsRealEstate> createState() => _AllAdsRealEstateState();
}

class _AllAdsRealEstateState extends State<AllAdsRealEstate> {
  // ✅ تم إضافة متغيرات الحالة لتخزين القيم المختارة
  String? _selectedType;
  String? _selectedDistrict;
  String? _selectedContract;
  String? _selectedPrice;

  // ✅ (جديد) ودجة تفاعلية لاختيار الفلاتر
