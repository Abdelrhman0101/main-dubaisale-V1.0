...
class CarsRentSaveAdScreen extends StatelessWidget {
  // استقبال دالة تغيير اللغة
  final Function(Locale) onLanguageChange;

  const CarsRentSaveAdScreen({Key? key, required this.onLanguageChange})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    const makeValue = 'Audi';
    const modelValue = 'S5';
    const trimValue = 'Tsfi';
          ...
          child: Column(
            ...
            children: [
              ...
              _buildFormRow([
                ...
                _buildTitledDropdownField(
                    context, s.make, ['Audi', 'BMW'], makeValue, borderColor),
              ]),
              const SizedBox(height: 7),

              _buildFormRow([
                _buildTitledDropdownField(
                    context, s.model, ['S5', 'A8'], modelValue, borderColor),
                _buildTitledDropdownField(
                    context, s.trim, ['Tsfi', 'TDI'], trimValue, borderColor),
                _buildTitledTextField(s.price, 'AED 600', borderColor, currentLocale, isNumber: true),
              ]),
              const SizedBox(height: 7),

              _buildFormRow([
                 _buildTitledDropdownField(
                     context, s.year, ['2022', '2021'], yearValue, borderColor),
                 _buildTitledTextField(s.dayRent, '600', borderColor, currentLocale, isNumber: true),
                 _buildTitledTextField(s.monthRent, '12000', borderColor, currentLocale, isNumber: true),
              ]),
              const SizedBox(height: 7),
              ...
              _buildTitledTextField(s.area, 'Deira', borderColor, currentLocale),
              const SizedBox(height: 7),

              _buildFormRow([
                 TitledTextFieldWithAction(title: s.phoneNumber, initialValue: '0097708236561', borderColor: borderColor, onAddPressed: (){ print("Add phone clicked"); }, isNumeric: true),
                 TitledTextFieldWithAction(title: s.whatsApp, initialValue: '0097708236561', borderColor: borderColor, onAddPressed: (){ print("Add whatsapp clicked"); }, isNumeric: true),
              ]),
              const SizedBox(height: 7),

              TitledTextFieldWithAction(title: s.advertiserName, initialValue: 'Alwan Rental', borderColor: borderColor, onAddPressed: (){ print("Add advertiser clicked"); }),
              const SizedBox(height: 7),
...
class TitledDescriptionBox extends StatefulWidget {
  ...
  const TitledDescriptionBox({
    Key? key, required this.title, required this.initialValue, required this.borderColor, this.maxLength = 5000
  }) : super(key: key);
  @override
