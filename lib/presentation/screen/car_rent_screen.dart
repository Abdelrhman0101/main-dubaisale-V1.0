                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildMultiSelectField(context, s.choose_make, _selectedMakes,
                          ["Toyota", "Honda", "Nissan", "Hyundai", "Kia"],
                           (selection) => setState(() => _selectedMakes = selection)),
                        
                        SizedBox(height: 3.h),
                       
                        _buildMultiSelectField(context, s.choose_model, _selectedModels, 
                          ["Yaris", "Corolla", "Civic", "Sunny", "Sportage"],
                           (selection) => setState(() => _selectedModels = selection)),
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  SvgPicture.asset( 'assets/icons/cardolar.svg', height: 25.sp, width: 24.sp),
                                  SizedBox(width: 16.w),
                                  Expanded(
                                    child: Text(
                                      s.click_for_deals,
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    reverse: false,
                                    itemCount: min(CarRentDummyData.length, 20),
                                    padding: EdgeInsetsDirectional.symmetric(
                                        horizontal: 5.w),
