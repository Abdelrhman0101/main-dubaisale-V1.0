...
class OtherServicesSaveAdScreen extends StatelessWidget {
  // استقبال دالة تغيير اللغة
  final Function(Locale) onLanguageChange;

  const OtherServicesSaveAdScreen({Key? key, required this.onLanguageChange})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    const sectionTypeValue = 'Financial Service';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildFormRow([
                 _buildTitledTextField(s.area, 'Jumeira1', borderColor, currentLocale),
                 _buildTitledTextField(s.price, 'AED 1000', borderColor, currentLocale, isNumber: true),
              ]),
              const SizedBox(height: 7),

               _buildFormRow([
                 _buildTitledTextField(s.serviceName, 'Account Audit', borderColor, currentLocale),
                 _buildTitledDropdownField(
                     context, s.sectionType, ['Financial Service', 'Legal Service'], sectionTypeValue, borderColor),
              ]),
              const SizedBox(height: 7),
              ...
              TitledTextFieldWithAction(title: s.advertiserName, initialValue: 'Al Rasema Accounting Office', borderColor: borderColor, onAddPressed: (){ print("Advertiser Add clicked"); }),
              const SizedBox(height: 7),
