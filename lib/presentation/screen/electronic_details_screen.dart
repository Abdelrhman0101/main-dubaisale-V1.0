...
class ElectronicDetailsScreen extends StatefulWidget {
  ...
  const ElectronicDetailsScreen({super.key, required this.electronic});
...
class _ElectronicDetailsScreenState extends State<ElectronicDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final electronic = widget.electronic;
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: PageView.builder(
                        ...
                        itemCount: electronic.images.length,
                        onPageChanged: (index) =>
                            setState(() => _currentPage = index),
                        itemBuilder: (context, index) => Image.asset(
                          electronic.images[index],
                          fit: BoxFit.cover,
                          width: double.infinity,
                        ),
                      ),
                    ...
                    Positioned(
                      ...
                      left: MediaQuery.of(context).size.width / 2 -
                          (electronic.images.length * 10.w / 2),
                      child: Row(
                        children:
                            List.generate(electronic.images.length, (index) {
                          return Container(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          '${_currentPage + 1}/${electronic.images.length}',
                          style:
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Directionality(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // RichText(
                            //   text: TextSpan(
                            //     children:  electronic.line1.split(' ').map((word) {
                      ...
                      //   children: [
                      //     _buildDetailBox(
                      //         S.of(context).car_type, widget.electronic.carType),
                      //     _buildDetailBox(
                      //         S.of(context).trans_type, widget.electronic.transType),
                      //     _buildDetailBox(
                      //         S.of(context).color, widget.electronic.color),
                      //     _buildDetailBox(S.of(context).interior_color,
                      //         widget.electronic.interiorColor),
                      //     _buildDetailBox(
                      //         S.of(context).fuel_type, widget.electronic.fuelType),
                      //     _buildDetailBox(
                      //         S.of(context).warranty, widget.electronic.warranty),
                      //     _buildDetailBox(S.of(context).doors_no,
                      //         widget.electronic.doors.toString()),
                      //     _buildDetailBox(S.of(context).seats_no,
                      //         widget.electronic.seats.toString()),
                      //     _buildDetailBox(S.of(context).engine_capacity,
                      //         widget.electronic.engineCapacity),
                      //     _buildDetailBox(S.of(context).cylinders,
                      //         widget.electronic.cylinders.toString()),
                      //     _buildDetailBox(
                      //         S.of(context).horse_power, widget.electronic.horsePower),
                      //     _buildDetailBox(S.of(context).steering_side,
                      //         widget.electronic.steeringSide),
                      //   ],
                      // ),
                      // SizedBox(height: 1.h),
                      Divider(color: Color(0xFFB5A9B1), thickness: 1.h),
                      ...
                      Directionality(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: ReadMoreText(
                                "Many mobiles offer and tablets and all kind \n of electronics",
                                trimLines: 2,
                                colorClickableText:
