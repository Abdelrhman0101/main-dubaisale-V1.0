...
import 'package:dropdown_search/dropdown_search.dart'; // ✅ تم إضافة المكتبة
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:flutter_svg/svg.dart';
import 'package:go_router/go_router.dart';

final Color KTextColor = Color(0xFF001E5B);

class AllAddsCarService extends StatefulWidget {
  const AllAddsCarService({super.key});

  @override
  State<AllAddsCarService> createState() => _AllAddsCarServiceState();
}

class _AllAddsCarServiceState extends State<AllAddsCarService> {
  // ✅ تم إضافة متغيرات الحالة للفلاتر
  String? _selectedServiceType;
  String? _selectedDistrict;
  String? _selectedPrice;

  // ✅ (جديد) ودجة الفلتر الموحدة باستخدام DropdownSearch
    ...
    return DropdownSearch<String>(
      ...
      dropdownBuilder: (context, selectedItem) {
        return Text(
          ...
          maxLines: 1,
          style: TextStyle(
            fontSize: 10.5.sp, // تم توحيد حجم الخط
            color: KTextColor,
      ...
      dropdownDecoratorProps: DropDownDecoratorProps(
        dropdownSearchDecoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.symmetric(horizontal: 10.w), // تعديل الحشو
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      // ✅ (تم التعديل) صف الفلاتر باستخدام الودجة الموحدة
                      // Padding(
                      //   padding:
