        ...
        body: SafeArea(
          child: Consumer<CarServicesProvider>(
            builder: (context, provider, child) {
              ...
              // الترتيب حسب تاريخ الإنشاء من الأحدث للأقدم
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Transform.scale(
                      ...
                      child: Switch(value: true, onChanged: (val) {}, activeColor: Colors.white, activeTrackColor: const Color(0xFF08C2C9), inactiveThumbColor: Colors.white, inactiveTrackColor: Colors.grey[300]),
                    ),
                  ),
                ],
              ),
