                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: _buildMultiSelectField(
                                        context, S.of(context).section, _selectedSections, const ["Mobiles", "Screens", "Appliances"],
                                        (selection) => setState(() => _selectedSections = selection), isFilter: true),
                                    ),
                                    SizedBox(width: 4.w),
                                    Expanded(
                                      child: _buildMultiSelectField(
                                        context, S.of(context).product, _selectedProducts, const ["New", "Used"],
                                        (selection) => setState(() => _selectedProducts = selection), isFilter: true),
                                    ),
                                  ],
                                ),
                              ),
