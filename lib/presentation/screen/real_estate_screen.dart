...
const Color KPrimaryColor = Color.fromRGBO(1, 84, 126, 1); // تم إرجاعه للون الأزرق الغامق
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      // +++ تم إزالة الـ Padding الزائد للحفاظ على المسافات +++
                      ...
                      _buildMultiSelectField(context, s.district, _selectedDistricts,
                        ["Downtown", "Marina", "JLT", "Business Bay", "Palm Jumeirah"],
                        (selection) => setState(() => _selectedDistricts = selection)),

                      SizedBox(height: 4.h),

                       _buildMultiSelectField(context, s.property_type, _selectedPropertyTypes,
                        ["Apartment", "Villa", "Townhouse", "Office", "Penthouse"],
                        (selection) => setState(() => _selectedPropertyTypes = selection)),
                      
                      SizedBox(height: 3.h),
                     
                       _buildMultiSelectField(context, s.contract_type, _selectedContractTypes,
                        ["For Sale", "For Rent"],
                        (selection) => setState(() => _selectedContractTypes = selection)),
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Padding(
                                      padding: EdgeInsetsDirectional.only( end: index == RealEstateDummyData.length - 1 ? 0 : 4.w,),
                                      child: Container(
                                        width: 145,
                                        decoration: BoxDecoration(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text( ad.details, maxLines: 1, overflow: TextOverflow.ellipsis,
              ...
              children: [
                ...
                Expanded(
                  child: _filteredItems.isEmpty 
                    ? Center(child: Text(s.noResultsFound, style: TextStyle(color: KTextColor))) // +++ استخدام الترجمة
                    : ListView.builder(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                        backgroundColor: KPrimaryColor, // +++ إرجاع اللون الأصلي
